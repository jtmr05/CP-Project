...
\>[B]{}\Varid{calcLine}\mathbin{::}\Conid{NPoint}\to (\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint}){}\<[E]%
\\
\>[B]{}\Varid{calcLine}\;\Varid{p}\;\Varid{x}\;\Varid{t}\mathrel{=}\Varid{cataList}\;\Varid{h}\;\Varid{list}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{h}\mathrel{=}\alt{\Varid{nil}}{\Varid{cons}\comp ((\mathbin{`\Varid{aux}`}\Varid{t})\times\Varid{id})}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{list}\mathrel{=}\Varid{zip}\;\Varid{p}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{aux}\mathrel{=}\uncurry{\Varid{linear1d}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{divide}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_2\;([\mskip1.5mu \mskip1.5mu],[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
